"""Vehicle dynamics and geometry for the simulator.

This module contains the Vehicle class that implements bicycle model dynamics
with Ackermann steering, used by both the simulator and RL environment.
"""
...
class Vehicle:
    def __init__(self, x=0, y=0):
        ...
        self.wheelbase = 0.4699  # L (18 inches)
        self.track_width = 0.4318  # W (12 inches)
